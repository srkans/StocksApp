namespace ServiceContracts
{
    ...
    public interface IFinnhubService
    {
        ...
        /// <returns>Returns a dictionary that contains details such as company country, currency, exchange, IPO date, market capitalization, name of the company, phone number etc.</returns>
